<html>
    <div class="input-group dropdown mod-langinp mod-langinp-init">
                    ...
                    <wb-foreach wb-from="_locales">
                        <div class="dropdown-item">
                            <div class="input-group">
                                ...
                                <textarea class="form-control" rows="auto" data-lang="{{_key}}" on-keyup="edit" name="{{_key}}" placeholder="{{label}}"></textarea>
                            </div>
                        </div>
                    </wb-foreach>
            </div>
        ...
        <textarea class="form-control mod-langinp" type="text" data-lang="{{_sess.lang}}" on-keyup="edit" name="label"></textarea>
    </div>
