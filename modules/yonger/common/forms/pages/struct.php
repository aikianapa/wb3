            ...
            <div class="modal-content">
                ...
                <div class="p-0 pb-5 modal-body scroll-y">
                    <ul class="list-group" wb-off>
                        {{#each blocks}}
                            <li class="cursor-pointer list-group-item d-flex align-items-center" on-click="select" data-name='{{name}}' data-id='{{id}}' data-header="{{header}}">
                                <img src="/module/myicons/search-checkmark-circle.svg?size=30&stroke=323232" class="wd-30 wh-30 rounded-circle mg-r-15" alt="" data-name="{{name}}">
                                <div>
...
<script>
    ...
    yonger.pageBlocks = function() {
        ...
        $blockform.undelegate(':input[name]', 'change paste');
        $blockform.delegate(':input[name]', 'change paste', function() {
            setTimeout(() => {
