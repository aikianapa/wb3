...
<script wb-app>
  wbapp.loadScripts([
    "/engine/modules/ckeditor/ckeditor/ckeditor.js", "/engine/modules/ckeditor/ckeditor/config.js",
    "/engine/modules/ckeditor/ckeditor/adapters/jquery.js"
    ...
    // fix end
    $(document).find('textarea.ck-editor').each(async function() {
