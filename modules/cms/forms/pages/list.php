...
<nav class="nav navbar navbar-expand-md col">
  ...
  <div class="collapse navbar-collapse order-2" id="navbarSupportedContent">
    ...
    <form class="form-inline mg-t-10 mg-lg-0">
      ...
      data-ajax="{'url':'/cms/ajax/form/pages/edit/_new','html':'.pages-edit-modal','modal':'#modalPagesEdit','callback':'ajaxModalShow'}">Создать</button>
    </form>
  </div>
</nav>
...
<div class="list-group m-2">
  <wb-foreach wb-table="pages" wb-orm="sortBy('id')">
    <div class="list-group-item d-flex align-items-center">
      <wb-var edit="{'url':'/cms/ajax/form/pages/edit/{{_id}}','html':'.pages-edit-modal','modal':'#modalPagesEdit','callback':'ajaxModalShow'}"/>
      <div>
