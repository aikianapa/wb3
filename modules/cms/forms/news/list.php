  ...
  <div class="collapse navbar-collapse order-2" id="navbarSupportedContent">
    ...
    data-ajax="{'target':'#{{_form}}List','filter_add':{'$or':[{ '_id' : {'$like' : '$value'} }, { 'header': {'$like' : '$value'} }]} }">
      ...
      <div class="form-group">
        <button class="btn btn-success" type="submit" data-ajax="{'url':'/cms/ajax/form/news/edit/_new','html':'.news-edit-modal'}">Создать</button>
      </div>
    </form>
  </div>
</nav>
...
<div class="list-group m-2" id="{{_form}}List">
  <wb-foreach data-ajax="{'url':'/ajax/form/{{_form}}/list/','bind':'cms.list.{{_form}}','render':'client','sort':'date:d','size':'{{_sett.page_size}}'}">
    <div class="list-group-item d-flex align-items-center">
      ...
      <a href="javascript:" data-ajax="{'url':'/cms/ajax/form/news/edit/{{_id}}','html':'.news-edit-modal'}"
      ...
      <div class="dropdown dropright pos-absolute r-10 p-0 m-0" style="line-height: normal;">
        ...
        <div class="dropdown-menu">
          <a class="dropdown-item" href="#" data-ajax="{'url':'/cms/ajax/form/news/edit/{{_id}}','html':'.news-edit-modal'}">Изменить</a>
